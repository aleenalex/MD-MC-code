...
double hist[maxbin];
double U, press, dt=0.0005, KE, Temp;
...
//Last Update on 20-MAr-2015
void thermostat(int index=1);//1-Anderson, 2-Berendsen
void anderson(double nu=5,double dt=0.0005);
void berendsen();
void velocity();
